...
import { EditRegister } from '../buttons';
              ...
              registersData?.map((register) => {
                ...
                return (
                  (
                    ...
                    >
                      <td className='whitespace-nowrap py-2 pl-6 pr-6'>{register.chofer.nombre} {register.chofer.apellido}</td>
                      <td className='whitespace-nowrap px-4 py-3'>{register.ayudante ? `${register.ayudante.nombre} ${register.ayudante.apellido}`: "-"}</td>
                      <td className='whitespace-nowrap px-4 py-3'>{register.vehiculo.reparto}</td>
                      <td className='whitespace-nowrap px-4 py-3'>{register.vehiculo.marca} {register.vehiculo.modelo}</td>
                      <td className='whitespace-nowrap px-4 py-3'>{register.vehiculo.patente}</td>
                      <td className='whitespace-nowrap px-4 py-3'>{fecha.toLocaleDateString('es-AR')}</td>
